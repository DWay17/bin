...
net use I: \\isilon01.zad.local\user
sleep 1
dir i:\
sleep 1
dir i:\richter-th\
...
start "" /B /min "c:\Programme\PingInfoView\PingInfoView.exe"
start "" /B /min "C:\Program Files\DavMail\davmail64.exe" >> %LOGDIR%\davmail64.log 2>&1
