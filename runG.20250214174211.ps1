    ...
    if ($lnkFiles) {
        ...
        foreach ($lnkFile in $lnkFiles) {
            ...
            try {
                ...
                $Shell = New-Object -ComObject -ComObject WScript.Shell
                ...
                $Shortcut = $Shell.CreateShortcut($lnkFile.FullName) # Shortcut-Objekt erstellen
                $TargetPath = $Shortcut.TargetPath

                # COM-Objekte freigeben, aber nur wenn sie nicht null sind
                if ($Shell) { [System.Runtime.InteropServices.Marshal]::ReleaseComObject($Shell) }
                if ($Shortcut) { [System.Runtime.InteropServices.Marshal]::ReleaseComObject($Shortcut) }
